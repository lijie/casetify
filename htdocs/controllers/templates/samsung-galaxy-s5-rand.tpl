...
<div class="design-template" data-tpl="samsung-galaxy-s3-rand">

<div class="placeholder grabbable" data-tpid="0" style="top:6px; left:19px; width:202px; height:198px;"></div>
<div class="placeholder grabbable" data-tpid="1" style="top:6px; left:221px; width:98px; height:99px;"></div>
<div class="placeholder grabbable" data-tpid="2" style="top:105px; left:221px; width:98px; height:99px;"></div>
<div class="placeholder grabbable" data-tpid="3" style="top:204px; left:19px; width:150px; height:150px;"></div>
<div class="placeholder grabbable" data-tpid="4" style="top:204px; left:169px; width:150px; height:150px;"></div>
<div class="placeholder grabbable" data-tpid="5" style="top:354px; left:19px; width:98px; height:99px;"></div>
<div class="placeholder grabbable" data-tpid="6" style="top:453px; left:19px; width:98px; height:100px;"></div>
<div class="placeholder grabbable" data-tpid="7" style="top:354px; left:117px; width:202px; height:200px;"></div>
