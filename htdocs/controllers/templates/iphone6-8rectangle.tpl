...
div.design-template .normal-grid { width: 144px; height: 144px; }
...
<div class="design-template" data-tpl="iphone5s-8rectangle">
	
	<div class="placeholder grabbable normal-grid" data-tpid="0" style="top:-8px; left:0px"></div>
	<div class="placeholder grabbable normal-grid" data-tpid="1" style="top:-8px; left:142px"></div>
	<div class="placeholder grabbable normal-grid" data-tpid="2" style="top:134px; left:0px"></div>
	<div class="placeholder grabbable normal-grid" data-tpid="3" style="top:134px; left:142px"></div>
	<div class="placeholder grabbable normal-grid" data-tpid="4" style="top:276px; left:0px"></div>
	<div class="placeholder grabbable normal-grid" data-tpid="5" style="top:276px; left:142px"></div>
	<div class="placeholder grabbable normal-grid" data-tpid="6" style="top:418px; left:0px"></div>
	<div class="placeholder grabbable normal-grid" data-tpid="7" style="top:418px; left:142px"></div>
